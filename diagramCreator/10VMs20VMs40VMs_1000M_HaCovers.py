...
outputFileName = '-102040Chunks-1000M-Ha'
if not isLatex:
...
if isLatex:
  ...
  TotalComputationalEffortDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'totalComputationalEffortPerResult', 'totalComputationalEffortPerResult' + outputFileName,
    ...
    titleGap=3, logScale=False, perResult=True, relativeValue="cover", relHeader=dataRowSelection[0], legendNameExtension="numberOfChunks")
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=0, logScale=False, legendNameExtension="numberOfChunks")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=1, logScale=False, legendNameExtension="numberOfChunks")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=2, logScale=False, legendNameExtension="numberOfChunks")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=3, logScale=False, legendNameExtension="numberOfChunks")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=4, logScale=False, legendNameExtension="numberOfChunks")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=6, logScale=False, legendNameExtension="numberOfChunks")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=7, logScale=False, legendNameExtension="numberOfChunks")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=8, logScale=False, legendNameExtension="numberOfChunks")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=9, logScale=False, legendNameExtension="numberOfChunks")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=10, logScale=False, legendNameExtension="numberOfChunks")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=11, logScale=False, legendNameExtension="numberOfChunks")
  latex.latexify(fig_height=1.95,fig_width=3,scale=1)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.05,-0.075,1.05,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=5, logScale=False, legendNameExtension="numberOfChunks")
