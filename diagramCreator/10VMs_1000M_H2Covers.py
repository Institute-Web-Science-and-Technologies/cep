...
if isLatex:
  ...
  LoadingTimeDiagram.createDiagram(inputDir + os.sep + 'loadingTime.csv', dataRowSelection, outputDir + os.sep + 'loadingTime', 'loading' + outputFileName,
    diagramScale=(-0.04,-0.04,1.04,1.045), legendScale=(0, 1.15, 1, .102), legendColumns=2, isLatex=isLatex, logScale=True)
  ...
  ChunkSizesDiagram.createDiagram(inputDir + os.sep + 'chunkSizes.csv', dataRowSelection, outputDir + os.sep + 'chunkSizes', 'chunkSizes' + outputFileName,
    diagramScale= (-0.04,-0.07,1.04,0.95), legendScale= (0, 1.12, 1, .102), legendColumns=2, isLatex=isLatex)
  ...
  ExecutionTimeDiagram.createDiagram(inputDir + os.sep + 'executionTimelines.csv', dataRowSelection, outputDir + os.sep + 'executionTime', 'executionTime' + outputFileName,
    diagramScale= (-0.05,-0.044,1.04,0.96), legendScale= (-0.4, 1.07, 1.4, .102), legendColumns= 2, isLatex=isLatex,
    titleGap=20, logScale=False, perResult=True)
  ExecutionTimeDiagram.createDiagram(inputDir + os.sep + 'executionTimelines.csv', dataRowSelection, outputDir + os.sep + 'executionTimeRel', 'executionTimeRel' + outputFileName,
    diagramScale= (-0.05,-0.044,1.04,0.97), legendScale= (-0.4, 1.06, 1.4, .102), legendColumns= 2, isLatex=isLatex,
  ...
  WorkloadImbalanceDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'workloadImbalance', 'workloadImbalance' + outputFileName,
    diagramScale= (-0.05,-0.044,1.04,0.95), legendScale= (-0.48, 1.1, 1.48, .102), legendColumns= 2, isLatex=isLatex,
    titleGap=0.02)
  TotalComputationalEffortDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'totalComputationalEffort', 'totalComputationalEffort' + outputFileName,
    ...
    titleGap=100000000, logScale=True, perResult=False)
  TotalComputationalEffortDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'totalComputationalEffort', 'totalComputationalEffortPerResult' + outputFileName,
    diagramScale= (-0.05,-0.044,1.04,0.97), legendScale= (-0.48, 1.06, 1.48, .102), legendColumns= 2, isLatex=isLatex,
    titleGap=100000000, logScale=True, perResult=True)
  TotalComputationalEffortDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'totalComputationalEffortPerResult', 'totalComputationalEffortPerResult' + outputFileName,
    diagramScale= (-0.05,-0.044,1.04,0.95), legendScale= (-0.48, 1.1, 1.48, .102), legendColumns= 2, isLatex=isLatex,
    titleGap=30, logScale=False, perResult=True, relativeValue="cover", relHeader=dataRowSelection[0])
  DataTransferDiagram.createDiagram(inputDir + os.sep + 'dataTransfer.csv', dataRowSelection, outputDir + os.sep + 'dataTransfer', 'dataTransfer' + outputFileName,
    diagramScale= (-0.05,-0.044,1.04,0.94), legendScale= (-0.34, 1.07, 1.34, .102), legendColumns= 2, isLatex=isLatex,
    onlySOJoin=True, titleGap=20, logScale=True, perResult=True)
  DataTransferDiagram.createDiagram(inputDir + os.sep + 'dataTransfer.csv', dataRowSelection, outputDir + os.sep + 'dataTransferRel', 'dataTransferRel' + outputFileName,
    diagramScale= (-0.04,-0.044,1.04,0.97), legendScale= (-0.4, 1.05, 1.4, .102), legendColumns= 2, isLatex=isLatex,
    onlySOJoin=True, titleGap=20, logScale=False, perResult=True, relativeValue="cover", relHeader=dataRowSelection[0])
  PackageTransferDiagram.createDiagram(inputDir + os.sep + 'packageTransfer.csv', dataRowSelection, outputDir + os.sep + 'packageTransfer', 'packageTransfer' + outputFileName,
    diagramScale= (-0.05,-0.044,1.04,0.96), legendScale= (-0.34, 1.07, 1.34, .102), legendColumns= 2, isLatex=isLatex,
    onlySOJoin=True, titleGap=20, logScale=False, perResult=True)
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=0, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=2, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=3, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=4, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=6, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=7, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=8, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=9, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=10, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=11, logScale=False)
  latex.latexify(fig_height=1.95,fig_width=3,scale=1)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.05,-0.075,1.05,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=1, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.05,-0.075,1.05,0.92), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=5, logScale=False)
  
else:
  LoadingTimeDiagram.createDiagram(inputDir + os.sep + 'loadingTime.csv', dataRowSelection, outputDir + os.sep + 'loadingTime', 'loading' + outputFileName,
    diagramScale=(0.0,0,1.0,1.), legendScale=(0, 1.1, 1, .102), legendColumns=2, isLatex=isLatex, logScale=True)
  ChunkSizesDiagram.createDiagram(inputDir + os.sep + 'chunkSizes.csv', dataRowSelection, outputDir + os.sep + 'chunkSizes', 'chunkSizes' + outputFileName,
