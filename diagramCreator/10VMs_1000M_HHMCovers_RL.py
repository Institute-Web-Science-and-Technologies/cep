...
#dataRowSelection.append({"cover":"HASH","n-hop":0,"numberOfChunks":20,"datasetSize":500000000,"treeType":"RIGHT_LINEAR","colour":'green'})
dataRowSelection.append({"cover":"HASH","n-hop":0,"numberOfChunks":10,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'green'})
#dataRowSelection.append({"cover":"HASH","n-hop":0,"numberOfChunks":20,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'lime'})
#dataRowSelection.append({"cover":"HASH","n-hop":0,"numberOfChunks":40,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'greenyellow'})
#dataRowSelection.append({"cover":"HASH","n-hop":0,"numberOfChunks":20,"datasetSize":2000000000,"treeType":"RIGHT_LINEAR","colour":'greenyellow'})

#dataRowSelection.append({"cover":"HIERARCHICAL","n-hop":0,"numberOfChunks":20,"datasetSize":500000000,"treeType":"RIGHT_LINEAR","colour":'darkblue'})
dataRowSelection.append({"cover":"HIERARCHICAL","n-hop":0,"numberOfChunks":10,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'darkblue'})
#dataRowSelection.append({"cover":"HIERARCHICAL","n-hop":0,"numberOfChunks":20,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'royalblue'})
#dataRowSelection.append({"cover":"HIERARCHICAL","n-hop":0,"numberOfChunks":40,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'cyan'})
#dataRowSelection.append({"cover":"HIERARCHICAL","n-hop":0,"numberOfChunks":20,"datasetSize":2000000000,"treeType":"RIGHT_LINEAR","colour":'cyan'})

#dataRowSelection.append({"cover":"MIN_EDGE_CUT","n-hop":0,"numberOfChunks":20,"datasetSize":500000000,"treeType":"RIGHT_LINEAR","colour":'darkred'})
dataRowSelection.append({"cover":"MIN_EDGE_CUT","n-hop":0,"numberOfChunks":10,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'darkred'})
#dataRowSelection.append({"cover":"MIN_EDGE_CUT","n-hop":0,"numberOfChunks":20,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'red'})
#dataRowSelection.append({"cover":"MIN_EDGE_CUT","n-hop":0,"numberOfChunks":40,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'lightsalmon'})
#dataRowSelection.append({"cover":"MIN_EDGE_CUT","n-hop":0,"numberOfChunks":20,"datasetSize":2000000000,"treeType":"RIGHT_LINEAR","colour":'lightsalmon'})

#dataRowSelection.append({"cover":"VERTICAL","n-hop":0,"numberOfChunks":10,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'gold'})

#dataRowSelection.append({"cover":"HASH","n-hop":2,"numberOfChunks":10,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'purple'})

#dataRowSelection.append({"cover":"HASH","n-hop":0,"numberOfChunks":1,"datasetSize":1000000000,"treeType":"RIGHT_LINEAR","colour":'grey'})

inputDir = sys.argv[1]
outputDir = sys.argv[2]
imageType = sys.argv[3]
isLatex = imageType == 'latex'
outputFileName = '-10Chunks-HHM-RL'
if not isLatex:
...
if isLatex:
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.05,-0.075,1.05,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=4, logScale=False)
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.03,-0.05,1.03,0.775), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=4, logScale=False, linewidth=5)
