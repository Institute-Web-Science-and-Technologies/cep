...
if isLatex:
  ...
  DataTransferDiagram.createDiagram(inputDir + os.sep + 'dataTransfer.csv', dataRowSelection, outputDir + os.sep + 'dataTransfer', 'dataTransfer' + outputFileName,
    diagramScale= (-0.05,-0.044,1.04,0.93), legendScale= (-0.4, 1.07, 1.4, .102), legendColumns= 2, isLatex=isLatex,
    onlySOJoin=False, titleGap=20, logScale=True, perResult=False)
  DataTransferDiagram.createDiagram(inputDir + os.sep + 'dataTransfer.csv', dataRowSelection, outputDir + os.sep + 'dataTransferRel', 'dataTransferRel' + outputFileName,
    ...
    onlySOJoin=True, titleGap=20, logScale=True, perResult=False, relativeValue="cover", relHeader=dataRowSelection[0])
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=0, logScale=True)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=1, logScale=True)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=2, logScale=True)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=3, logScale=True)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=4, logScale=True)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=6, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=7, logScale=True)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=8, logScale=False)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=9, logScale=True)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=10, logScale=True)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=11, logScale=True)
  latex.latexify(fig_height=1.95,fig_width=3,scale=1)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.05,-0.075,1.05,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=5, logScale=True)
  ...
  TotalComputationalEffortDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'totalComputationalEffortPerResult', 'totalComputationalEffortPerResult' + outputFileName,
    ...
    titleGap=20, logScale=False, perResult=False, relativeValue="cover", relHeader=dataRowSelection[0])
  DataTransferDiagram.createDiagram(inputDir + os.sep + 'dataTransfer.csv', dataRowSelection, outputDir + os.sep + 'dataTransfer', 'dataTransfer' + outputFileName,
    diagramScale= (0.01,0,1.0,0.9), legendScale= (-0.2, 1.04, 1.2, .102), legendColumns= 2, isLatex=isLatex,
    onlySOJoin=False, titleGap=20, logScale=True, perResult=False)
  DataTransferDiagram.createDiagram(inputDir + os.sep + 'dataTransfer.csv', dataRowSelection, outputDir + os.sep + 'dataTransferRel', 'dataTransferRel' + outputFileName,
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=0, logScale=True, linewidth=5)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=1, logScale=True, linewidth=5)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=2, logScale=True, linewidth=5)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=3, logScale=True, linewidth=5)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=4, logScale=True, linewidth=5)
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=7, logScale=True, linewidth=5)
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=9, logScale=True, linewidth=5)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=10, logScale=True, linewidth=5)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=11, logScale=True, linewidth=5)
  matplotlib.rcParams.update({'figure.figsize': (6, 5)})
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.03,-0.05,1.03,0.775), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=5, logScale=True, linewidth=5)
