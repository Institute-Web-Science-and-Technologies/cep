...
outputFileName = '-20Chunks-500M1000M2000M-Ha'
if not isLatex:
...
if isLatex:
  ...
  ExecutionTimeDiagram.createDiagram(inputDir + os.sep + 'executionTimelines.csv', dataRowSelection, outputDir + os.sep + 'executionTime', 'executionTime' + outputFileName,
    ...
    titleGap=20, logScale=False, perResult=True, legendNameExtension="datasetSize")
  ExecutionTimeDiagram.createDiagram(inputDir + os.sep + 'executionTimelines.csv', dataRowSelection, outputDir + os.sep + 'executionTimeRel', 'executionTimeRel' + outputFileName,
    ...
    titleGap=20, logScale=True, perResult=True, relativeValue="cover", relHeader=dataRowSelection[0], legendNameExtension="datasetSize")
  WorkloadImbalanceDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'workloadImbalance', 'workloadImbalance' + outputFileName,
    ...
    titleGap=0.02, legendNameExtension="datasetSize")
  TotalComputationalEffortDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'totalComputationalEffort', 'totalComputationalEffort' + outputFileName,
    ...
    titleGap=100000000, logScale=True, legendNameExtension="datasetSize")
  TotalComputationalEffortDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'totalComputationalEffort', 'totalComputationalEffortPerResult' + outputFileName,
    diagramScale= (-0.05,-0.044,1.04,0.91), legendScale= (-0.48, 1.12, 1.48, .102), legendColumns= 2, isLatex=isLatex,
    titleGap=5000, logScale=True, perResult=True, legendNameExtension="datasetSize")
  TotalComputationalEffortDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'totalComputationalEffortPerResult', 'totalComputationalEffortPerResult' + outputFileName,
    ...
    titleGap=20, logScale=False, perResult=True, relativeValue="cover", relHeader=dataRowSelection[0], legendNameExtension="datasetSize")
  DataTransferDiagram.createDiagram(inputDir + os.sep + 'dataTransfer.csv', dataRowSelection, outputDir + os.sep + 'dataTransfer', 'dataTransfer' + outputFileName,
    diagramScale= (-0.05,-0.044,1.04,0.93), legendScale= (-0.3, 1.07, 1.3, .102), legendColumns= 2, isLatex=isLatex,
    onlySOJoin=True, titleGap=20, logScale=False, perResult=True, legendNameExtension="datasetSize")
  DataTransferDiagram.createDiagram(inputDir + os.sep + 'dataTransfer.csv', dataRowSelection, outputDir + os.sep + 'dataTransferRel', 'dataTransferRel' + outputFileName,
    diagramScale= (-0.04,-0.044,1.04,0.97), legendScale= (-0.36, 1.05, 1.36, .102), legendColumns= 2, isLatex=isLatex,
    onlySOJoin=True, titleGap=20, logScale=False, perResult=True, relativeValue="cover", relHeader=dataRowSelection[0], legendNameExtension="datasetSize")
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=0, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=1, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=3, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=4, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=6, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=7, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=8, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=9, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=10, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=11, logScale=False, legendNameExtension="datasetSize")
  latex.latexify(fig_height=1.95,fig_width=3,scale=1)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.05,-0.075,1.05,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=2, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.05,-0.075,1.05,0.86), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=5, logScale=False, legendNameExtension="datasetSize")
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=0, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=1, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=3, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=4, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=6, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=7, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=8, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=9, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=10, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=11, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  matplotlib.rcParams.update({'figure.figsize': (6, 5)})
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.03,-0.05,1.03,0.775), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=2, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.03,-0.05,1.03,0.775), legendScale=(0, 1.02, 1, 0), legendColumns=1, isLatex=isLatex, query=5, logScale=False, linewidth=5, legendNameExtension="datasetSize")
