...
outputFileName = '-20Chunks-500M1000M2000M-M'
if not isLatex:
...
if isLatex:
  ...
  TotalComputationalEffortDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'totalComputationalEffortPerResult', 'totalComputationalEffortPerResult' + outputFileName,
    diagramScale= (-0.05,-0.044,1.04,0.92), legendScale= (-0.1, 1.1, 1.1, .102), legendColumns= 1, isLatex=isLatex,
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=0, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=1, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=2, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=3, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=4, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=6, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=7, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=8, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=9, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=10, logScale=False, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.065,-0.075,1.065,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=11, logScale=False, legendNameExtension="datasetSize")
  latex.latexify(fig_height=1.95,fig_width=3,scale=1)
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.05,-0.075,1.05,0.84), legendScale=(-0.23, 1.07, 1.23, 0), legendColumns=1, isLatex=isLatex, query=5, logScale=False, legendNameExtension="datasetSize")
  ...
  TotalComputationalEffortDiagram.createDiagram(inputDir + os.sep + 'computationalEffort.csv', dataRowSelection, outputDir + os.sep + 'totalComputationalEffortPerResult', 'totalComputationalEffortPerResult' + outputFileName,
    diagramScale= (0.01,0,1.0,0.9), legendScale= (-0.3, 1.1, 1.3, .102), legendColumns= 2, isLatex=isLatex,
    titleGap=20, logScale=False, perResult=False, relativeValue="cover", relHeader=dataRowSelection[0], legendNameExtension="datasetSize")
  DataTransferDiagram.createDiagram(inputDir + os.sep + 'dataTransfer.csv', dataRowSelection, outputDir + os.sep + 'dataTransfer', 'dataTransfer' + outputFileName,
    diagramScale= (0.01,0,1.0,0.9), legendScale= (-0.2, 1.04, 1.2, .102), legendColumns= 2, isLatex=isLatex,
    onlySOJoin=True, titleGap=20, logScale=False, perResult=True, legendNameExtension="datasetSize")
  DataTransferDiagram.createDiagram(inputDir + os.sep + 'dataTransfer.csv', dataRowSelection, outputDir + os.sep + 'dataTransferRel', 'dataTransferRel' + outputFileName,
  ...
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=0, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=1, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=2, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=3, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=4, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=6, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=7, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=8, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=9, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=10, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.04,-0.05,1.04,0.795), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=11, logScale=False, linewidth=5, legendNameExtension="datasetSize")
  matplotlib.rcParams.update({'figure.figsize': (6, 5)})
  ResultsOverTimeDiagram.createDiagram(inputDir + os.sep + 'plainResultsOverTime.csv', dataRowSelection, outputDir + os.sep + 'resultsOverTime', 'resultsOverTime' + outputFileName, diagramScale=(-0.03,-0.05,1.03,0.775), legendScale=(-0.1, 1.05, 1.1, 0), legendColumns=1, isLatex=isLatex, query=5, logScale=False, linewidth=5, legendNameExtension="datasetSize")
