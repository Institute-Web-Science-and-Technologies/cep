...
import diagramCreators.ChunkSizesCompEffortDiagram as ChunkSizesCompEffortDiagram
...
if isLatex:
  ...
  ChunkSizesCompEffortDiagram.createDiagram(inputDir + os.sep + 'chunkSizes.csv',inputDir + os.sep + 'computationalEffortPerChunk.csv', dataRowFilter, outputDir + os.sep + 'chunkSizesEffort', 'chunkSizesEffort' + outputFileName,
    diagramScale= (-0.02,-0.05,1.02,0.84), legendScale= (0, 1.1, 1, .102), legendColumns=2, isLatex=isLatex, logScale=True)
  ...
  ChunkSizesCompEffortDiagram.createDiagram(inputDir + os.sep + 'chunkSizes.csv',inputDir + os.sep + 'computationalEffortPerChunk.csv', dataRowFilter, outputDir + os.sep + 'chunkSizesEffort', 'chunkSizesEffort' + outputFileName,
    diagramScale= (-0.01,-0.05,1.01,0.84), legendScale= (0, 1.1, 1, .102), legendColumns=2, isLatex=isLatex, logScale=True)
  ...
  dataRowFilter={"cover":"HASH","n-hop":0,"numberOfChunks":10,"datasetSize":1000000000,"treeType":"BUSHY","colour":'green'}
  ChunkSizesCompEffortDiagram.createDiagram(inputDir + os.sep + 'chunkSizes.csv',inputDir + os.sep + 'computationalEffortPerChunk.csv', dataRowFilter, outputDir + os.sep + 'chunkSizesEffort', 'chunkSizesEffort' + outputFileName,
    diagramScale= (-0.01,-0.03,1.01,0.84), legendScale= (0, 1.1, 1, .102), legendColumns=2, isLatex=isLatex, logScale=True)
  dataRowFilter={"cover":"HIERARCHICAL","n-hop":0,"numberOfChunks":10,"datasetSize":1000000000,"treeType":"BUSHY","colour":'darkblue'}
  ChunkSizesCompEffortDiagram.createDiagram(inputDir + os.sep + 'chunkSizes.csv',inputDir + os.sep + 'computationalEffortPerChunk.csv', dataRowFilter, outputDir + os.sep + 'chunkSizesEffort', 'chunkSizesEffort' + outputFileName,
    diagramScale= (-0.01,-0.03,1.01,0.84), legendScale= (0, 1.1, 1, .102), legendColumns=2, isLatex=isLatex, logScale=True)
  dataRowFilter={"cover":"MIN_EDGE_CUT","n-hop":0,"numberOfChunks":10,"datasetSize":1000000000,"treeType":"BUSHY","colour":'darkred'}
