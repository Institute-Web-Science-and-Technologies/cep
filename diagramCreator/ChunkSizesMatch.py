...
if isLatex:
  ...
  ChunkSizesMatchDiagram.createDiagram(inputDir + os.sep + 'chunkSizes.csv',inputDir + os.sep + 'operationOutput.csv', dataRowFilter, outputDir + os.sep + 'chunkSizesMatch', 'chunkSizesMatch' + outputFileName,
