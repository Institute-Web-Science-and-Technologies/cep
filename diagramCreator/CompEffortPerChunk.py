...
if isLatex:
  ...
  ChunkSizesCompEffortDiagram.createDiagram(None,inputDir + os.sep + 'computationalEffortPerChunk.csv', dataRowFilter, outputDir + os.sep + 'compEffortPerSlave', 'compEffortPerSlave' + outputFileName,
