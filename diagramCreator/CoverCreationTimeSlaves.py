...
plt.xlabel('Number of Graph Chunks')
ax.yaxis.set_label_coords(-0.1,0.4)
plt.xticks(ind, scaleList)
...
if imageType=="latex":
  ...
  latex.savefig(outputDir,'coverCreationTimeSlaves')
else:
  plt.savefig(outputDir+'/coverCreationTimeSlaves.'+imageType, bbox_inches='tight')
