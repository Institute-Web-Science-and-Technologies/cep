...
outputFileName = '-20Chunks-500M1000M2000M-HHM'
if not isLatex:
...
if isLatex:
  ...
  LoadingTimeDiagram.createDiagram(inputDir + os.sep + 'loadingTime.csv', dataRowSelection, outputDir + os.sep + 'loadingTime', 'loading' + outputFileName,
    diagramScale=(-0.04,-0.08,1.04,0.93), legendScale=(0, 1.02, 1, .102), legendColumns=2, isLatex=isLatex, xTickDescriptor="datasetSize", xLabel="Number of Triples")
else:
  LoadingTimeDiagram.createDiagram(inputDir + os.sep + 'loadingTime.csv', dataRowSelection, outputDir + os.sep + 'loadingTime', 'loading' + outputFileName,
    diagramScale=(0.0,0,1.0,0.9), legendScale=(0, 1.02, 1, .102), legendColumns=2, isLatex=isLatex, xTickDescriptor="datasetSize", xLabel="Number of Triples")